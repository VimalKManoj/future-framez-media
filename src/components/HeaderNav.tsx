...
import FFMLogo from "../../public/ffmlogo.png";
...
function HeaderNav() {
  return (
    <div
      className={`${secondary.className} fixed top-0 w-full flex   items-center px-28 py-6 z-50 `}
    >
      {/* Left-aligned FFM */}
      ...
      {/* Centered Links */}
      <div className="w-1/3 bg-black/20 backdrop-blur-lg rounded-full h-14 flex justify-around items-center px-8 border border-white/10">
        {links.map((link) => (
